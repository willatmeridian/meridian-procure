                  ...
                  <div className="mt-6 pt-6 border-t">
                    ...
                    <div className="space-y-2 text-sm text-gray-600">
                      <div className="flex items-center gap-2">
                        ...
                        <a href="tel:+12144448963" onClick={() => gtag_report_conversion('tel:+12144448963')} className="[font-family:'Instrument_Sans',Helvetica] hover:text-blue-600 cursor-pointer">(214) 444-8963</a>
                      </div>
                      <div className="flex items-center gap-2">
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                        </svg>
                        <span className="[font-family:'Instrument_Sans',Helvetica]">info@meridianpkg.com</span>
                      </div>
                    </div>
                  </div>
                </div>
