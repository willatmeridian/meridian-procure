...
const HubSpotQuoteForm = ({ formId = null }) => {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      console.log('HubSpot Quote Form - GCLID captured:', gclid);
      if (gclid) {
        setFormData(prev => ({ ...prev, gclid }));
        console.log('HubSpot Quote Form - GCLID set in form state');
      }
    }
  }, []);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('HubSpot Quote Form - Form data before transform:', formData);
      const transformedData = transformFormData(formData);
      console.log('HubSpot Quote Form - Transformed data:', transformedData);
